...
--
-- Dumping events for database 'book_store'
--
...
in uid int unsigned,
in uname varchar(20),
in amoun int unsigned,
in bprice double)
    SQL SECURITY INVOKER
begin
	declare total double; 
	set total = bprice * amoun;
    insert into book_store.shopping_cart values(id,isbn,bname,uid,uname,amoun,bprice,total);
end ;;
DELIMITER ;
...
-- Dump completed on 2019-05-07 11:24:25
